...
export async function generateMetadata({
    ...
    const url = `${baseUrl}${localePath("/terms", locale)}`;
    ...
    return {
        ...
        alternates: {
            canonical: url,
            languages: {
                en: `${baseUrl}${localePath("/terms", routing.defaultLocale)}`,
                es: `${baseUrl}${localePath("/terms", "es")}`,
                "x-default": `${baseUrl}${localePath("/terms", routing.defaultLocale)}`,
            },
        },
    };
}
